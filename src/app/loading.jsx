...
export default function Loading() {
    return (
        <div className={`${s.loadercontainer}`}>
            <svg className={`${s.loader}`} style="margin: auto; background: none; display: block; shape-rendering: auto;" width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
